this.AdminProjectsDetailsSequencedetailsTaskeditController = RouteController.extend({
	template: "Admin",
	

	yieldTemplates: {
		'AdminProjectsDetailsSequencedetailsTaskedit': { to: 'AdminProjectsDetailsSequencedetailsSubcontent'},
