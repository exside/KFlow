this.AdminEvaluationsDetailsEvaluationitemdetailsEvaluationitemoptiondetailsController = RouteController.extend({
	template: "Admin",
	

	yieldTemplates: {
		'AdminEvaluationsDetailsEvaluationitemdetailsEvaluationitemoptiondetails': { to: 'AdminEvaluationsDetailsEvaluationitemdetailsSubcontent'},
